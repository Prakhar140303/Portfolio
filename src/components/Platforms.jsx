  ...
  return (
    <motion.section id='platforms' className='dm:my-16 sm:my-8 m-4'>
        ...
        <div className='flex flex-col'>
            ...
            <div className="bg-[#141321] shadow-md rounded-xl p-4 max-w-md mx-auto border-2">
            ...
            <section className="  text-center">
                ...
                <div className="flex flex-col  justify-center items-center gap-8">
                    ...
                    alt="GitHub Stats"
                    className="rounded-xl shadow-lg w-[340px] md:w-[420px] border-2"
                    />
                ...
                <div className="mt-8">
                    ...
                    alt="Top Languages"
                    className="rounded-xl shadow-lg mx-auto w-[320px] md:w-[400px] border-2"
                    />
                </div>
            </section>
        </div>
